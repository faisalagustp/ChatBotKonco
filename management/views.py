...
from management.models import scheduled_post, survey as Survey, user_account as UserAccount, scheduled_post_report, survey_value as SurveyValue
...
def add_survey(request):
    if request.method=="POST":
        with transaction.atomic():
            ...
            srvy.description = request.POST.get("datetime")
